...
Canonical procedure: `core/sdlc/post-release-review.md`. Read it before
running this skill.
...
1. Read `core/sdlc/post-release-review.md`.
...
skills/rules or `core/` — propose changes only. Never read, print, or commit
secrets from incident logs/support tickets.

## References

- `core/sdlc/post-release-review.md` — full process
- `feature-plan` (`core/sdlc/feature-planning.md`) — where follow-ups land
