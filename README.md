...
Public, versioned reusable GitHub Actions workflows for UTE and client repositories.

The repository contains generic CI/CD code only: no UTE network topology, no
...
GitHub-hosted runner → GitOps pull request → client/UTE Argo CD
